...
describe("SubagentPane", () => {
  ...
  it("recovers a child session from the runtime session parent link", () => {
    useRuntimeStore.setState({
      sessions: [{ id: "child-3", title: "Screen candidates", parentId: "parent", running: true, created: 1000, updated: 2000 }],
      sessionParents: { "child-3": "parent" },
      threads: { parent: { blocks: [], index: {}, loaded: true }, "child-3": { blocks: [], index: {}, loaded: true } },
    });
