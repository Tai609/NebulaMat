...
export function ToolGroup({
  ...
  // Pending means the outcome is unknown, not that execution is still live.
  // Only a running tool (or live reasoning) is allowed to animate this group.
  const active = streamingHere || tools.some((b) => b.status === "running");
