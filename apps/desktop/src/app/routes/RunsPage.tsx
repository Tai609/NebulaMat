...
function RunsView({ sessionId }: { sessionId?: string }) {
  ...
  // The ledger is written by runtime events, not by this component. Refresh
  // while the pane is open so a run that finishes in the adjacent chat appears
  // without forcing the user to close/reopen the inspector.
