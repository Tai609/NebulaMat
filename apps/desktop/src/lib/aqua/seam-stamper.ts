 ...
 * ARIA roles) or the stable NebulaMat seams (`data-aqua-main`,
 * `.sidebar-surface`).
 *
...
const SEAMS: readonly Seam[] = [
  // NebulaMat owns this seam directly. Avoid a leading :has() selector here:
  // jsdom and older embedded WebViews reject it before any Aqua CSS runs.
  { attribute: 'data-dsh-frame', selector: '[data-dsh-frame]' },
  ...
  { attribute: 'data-dsh-sidebar-root', selector: '.sidebar-surface, [class*="sidebarCol"] [class*="root"]', first: true },
  ...
  // Composer bar root is stamped by SessionView because it is a stable
  // NebulaMat wrapper rather than a DSH-generated class.
  { attribute: 'data-dsh-inputbar', selector: '[data-dsh-inputbar]' },
  ...
  { attribute: 'data-dsh-aqua-spot', selector: '.sidebar-surface, [class*="sidebarCol"]', first: true },
