...
allowed-tools: Bash(*), Read, Write, Edit, Grep, Glob, WebSearch, mcp__codex-image2__generate, mcp__codex-image2__generate_start, mcp__codex-image2__generate_status, subagent, send_message
---

## NebulaMat integration contract

This upstream ARIS Codex workflow is installed as `aris-paper-illustration-image2`. Apply these rules before the upstream instructions:
...
- **OPTIONAL_TEXT_CRITIC = `subagent`** — Optional text-only second opinion for layout/style checks
...
- **IMAGE2_HELPER** — canonical name `paper_illustration_image2.py`, resolved
  ...
  [ -f "$ARIS_REPO/skills/skills-codex/paper-illustration-image2/scripts/paper_illustration_image2.py" ] && IMAGE2_HELPER="$ARIS_REPO/skills/skills-codex/paper-illustration-image2/scripts/paper_illustration_image2.py"
  ...
  [ -z "$IMAGE2_HELPER" ] && [ -f $ARIS_REPO/skills/skills-codex/paper-illustration-image2/scripts/paper_illustration_image2.py ] && IMAGE2_HELPER="$ARIS_REPO/skills/skills-codex/paper-illustration-image2/scripts/paper_illustration_image2.py"
  [ -z "$IMAGE2_HELPER" ] && {
    echo "ERROR: paper_illustration_image2.py not resolved at $ARIS_REPO/skills/skills-codex/, \$ARIS_REPO/skills/, \$ARIS_REPO/tools/, tools/, or $ARIS_REPO/skills/skills-codex/." >&2
    echo "       /aris-paper-illustration-image2 cannot proceed. Fix: rerun install_aris_codex.sh, export ARIS_REPO, or copy the canonical skill into $ARIS_REPO/skills/skills-codex/." >&2
    exit 1
  }
  ```
...
**Not for:** Statistical plots (use `/aris-paper-figure`), deterministic vector topology figures (prefer `/aris-figure-spec`), photo-realistic scenes
...
If `subagent` is available, you may ask it for a short second-opinion
...
If `subagent` is available, you may ask it for a short text-only
