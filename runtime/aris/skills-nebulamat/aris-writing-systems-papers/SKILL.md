...
This upstream ARIS Codex workflow is installed as `aris-writing-systems-papers`. Apply these rules before the upstream instructions:
...
13. Hand off to /aris-paper-write for LaTeX generation and citation verification
```
...
- [ ] All citations verified (delegate to /aris-paper-write)
...
- Never generate citations from memory — use /aris-paper-write citation workflow
