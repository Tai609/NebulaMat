...
This upstream ARIS Codex workflow is installed as `aris-invention-structuring`. Apply these rules before the upstream instructions:
...
Adapted from the refinement pattern in `/aris-research-refine` for patent invention decomposition.
