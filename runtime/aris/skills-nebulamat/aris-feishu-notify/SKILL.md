...
description: "Send notifications to Feishu/Lark. Internal utility used by other skills, or manually via /aris-feishu-notify. Use when user says \"发飞书\", \"notify feishu\", or other skills need to send status updates."
---

## NebulaMat integration contract

This upstream ARIS Codex workflow is installed as `aris-feishu-notify`. Apply these rules before the upstream instructions:
