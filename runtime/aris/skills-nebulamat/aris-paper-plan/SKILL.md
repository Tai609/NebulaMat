...
This upstream ARIS Codex workflow is installed as `aris-paper-plan`. Apply these rules before the upstream instructions:
...
5. **CLAIMS_FROM_RESULTS.md** — structured claim judgment from `/aris-result-to-claim` (preferred if available)
