...
This upstream ARIS Codex workflow is installed as `aris-integrity-forensics`. Apply these rules before the upstream instructions:
...
> `subagent` would REWRITE an upstream contract — forbidden.
