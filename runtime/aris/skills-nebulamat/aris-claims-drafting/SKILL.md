...
This upstream ARIS Codex workflow is installed as `aris-claims-drafting`. Apply these rules before the upstream instructions:
...
4. Re-submit to the same examiner via `send_message` using the saved reviewer id
