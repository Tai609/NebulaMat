...
This upstream ARIS Codex workflow is installed as `aris-ablation-planner`. Apply these rules before the upstream instructions:
...
- `/aris-auto-review-loop` identifies missing ablations
...
- Confirmed and intended claims (from `/aris-result-to-claim` output or project notes)
