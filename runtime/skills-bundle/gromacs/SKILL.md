...
| understand `.top`/`.itp`, `[defaults]`, atom types, 1-4 interactions, include order, water/ligand integration | `references/topology-and-force-fields.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/force-fields.md` |
| choose `.mdp` parameters: integrator, timestep, outputs, PME/cutoffs, thermostat/barostat, constraints, restraints, pull/electric fields | `references/mdp-options.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/molecular-dynamics.md` |
