...
This upstream ARIS Codex workflow is installed as `aris-figure-description`. Apply these rules before the upstream instructions:
...
Unlike `/aris-paper-figure` which generates data plots, this skill processes user-provided technical diagrams and assigns reference numerals.
