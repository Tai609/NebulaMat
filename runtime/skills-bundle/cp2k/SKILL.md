...
| low-dimensional electrostatics: molecule boxes, slabs, 2D/1D, charged cells, dipoles, work functions | `references/low-dimensional-electrostatics.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/periodic-electrostatics.md` |
...
| DFT+U and magnetic starting states | `references/dftu-magnetism.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/hubbard-u-and-magnetism.md` |
| DOS/PDOS, bands, Molden/Multiwfn, cubes, density difference, charges, bond order, visualization | `references/electronic-analysis.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/electronic-structure.md`, `__NEBULAMAT_AICC_ROOT__/knowledge/bonding-analysis.md`, and `__NEBULAMAT_AICC_ROOT__/knowledge/scientific-visualization.md` |
| reproducible cube/Molden/ELF/spin-density/headless PyVista/VESTA/VMD rendering | `references/volumetric-visualization.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/scientific-visualization.md` |
| vibrational analysis, phonons, imaginary modes, IR/Raman prerequisites | `references/vibration-phonon.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/vibrational-phonon-analysis.md`; for finite-displacement phonons use `__NEBULAMAT_AICC_ROOT__/tools/phonopy/SKILL.md` |
| NEB/BAND reaction paths and transition-state validation | `references/neb-dimer.md`; kinetics science: `__NEBULAMAT_AICC_ROOT__/knowledge/reaction-kinetics.md` |
| AIMD/PIMD/metadynamics statistics and trajectory analysis | `references/aimd.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/molecular-dynamics.md` |
| adsorption, surface, defect, reaction, and thermal correction energy expressions | science: `__NEBULAMAT_AICC_ROOT__/knowledge/thermochemistry-and-free-energy.md` and `__NEBULAMAT_AICC_ROOT__/knowledge/surface-thermodynamics.md`; keep every compared energy on identical settings (`references/validation.md`) |
| SCCS and implicit solvent | `references/sccs-solvation.md`; electrostatics science: `__NEBULAMAT_AICC_ROOT__/knowledge/periodic-electrostatics.md` |
| TDDFT, UV-Vis, XAS, and excited-state spectra | `references/tddft-xas.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/excited-state-and-core-spectroscopy.md` |
| NMR and magnetic-response properties | `references/nmr.md`; science: `__NEBULAMAT_AICC_ROOT__/knowledge/excited-state-and-core-spectroscopy.md` |
...
1. Decide the scientific question first; if it is code-agnostic, read the matching `__NEBULAMAT_AICC_ROOT__/knowledge/` doc before choosing CP2K settings.
