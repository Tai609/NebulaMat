...
This upstream ARIS Codex workflow is installed as `aris-research-refine`. Apply these rules before the upstream instructions:
...
- **Save `agent_id` from Phase 2** and use `send_message` for later rounds.
