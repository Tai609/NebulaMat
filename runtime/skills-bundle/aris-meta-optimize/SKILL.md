...
This upstream ARIS Codex workflow is installed as `aris-meta-optimize`. Apply these rules before the upstream instructions:
...
{"ts":"...","session":"...","event":"subagent","tool":"subagent","input_summary":"review..."}
