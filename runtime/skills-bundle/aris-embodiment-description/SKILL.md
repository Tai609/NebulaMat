...
This upstream ARIS Codex workflow is installed as `aris-embodiment-description`. Apply these rules before the upstream instructions:
...
4. `patent/figures/numeral_index.md` if it exists (from `/aris-figure-description`)
