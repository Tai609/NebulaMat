...
**Execution:** I'll use superpowers:subagent-driven-development — dispatching a fresh subagent per task with review between tasks (or sequential execution with checkpoints when subagents are unavailable).
