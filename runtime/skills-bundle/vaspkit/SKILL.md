...
| DOS/band postprocessing: TDOS/PDOS, projected bands, d-band center, Fermi-level shift, adsorbate/surface orbital extraction | `references/dos-band.md`; pair with `__NEBULAMAT_AICC_ROOT__/tools/vasp/references/dos-band.md` |
| electronic-analysis postprocessing: charge-density difference, planar average, work function, Bader coloring, real-space wavefunction, partial/orbital charge | `references/electronic-analysis.md`; pair with `__NEBULAMAT_AICC_ROOT__/tools/vasp/references/electronic-analysis.md` |
| thermochemistry/free energy: fix atoms for frequencies, VASPKIT 501/502, gas chemical potentials for high-temperature work, surface thermodynamics, reaction profiles, and single-atom/defect stability diagrams | `references/thermochemistry.md`; for the science pair with `__NEBULAMAT_AICC_ROOT__/knowledge/thermochemistry-and-free-energy.md` and `__NEBULAMAT_AICC_ROOT__/knowledge/surface-thermodynamics.md` |
| AIMD post-processing: MSD/diffusion, VACF, VDOS, RDF/trajectory conversion, frame cuts and fit windows | `references/aimd-postprocessing.md`; pair with `__NEBULAMAT_AICC_ROOT__/tools/vasp/references/aimd.md` |
