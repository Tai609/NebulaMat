...
This upstream ARIS Codex workflow is installed as `aris-jurisdiction-format`. Apply these rules before the upstream instructions:
...
Analogous to `/aris-paper-compile` but for patent document formatting instead of LaTeX.
