...
This upstream ARIS Codex workflow is installed as `aris-result-to-claim`. Apply these rules before the upstream instructions:
...
if research-wiki/ exists:
    ...
    #    sound-modulo-imports / drafted / retracted), owned by /aris-proof-checker (the claim
