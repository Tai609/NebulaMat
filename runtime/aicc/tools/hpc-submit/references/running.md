...
Engine-specific GPU launch templates and INCAR/input parallelization caveats live in the engine skill — for VASP, `__NEBULAMAT_AICC_ROOT__/tools/vasp/references/gpu-openacc.md`.
