...
| scheduler/job script, partition/account, module/binary/launcher | `__NEBULAMAT_AICC_ROOT__/tools/hpc-submit/SKILL.md`; read the target `~/.cluster-agents.md` before writing the script |
